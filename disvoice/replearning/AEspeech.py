...
class AEspeech:
    ...
    def show_spectrograms(self, spectrograms):
        ...
        for k in range(spectrograms.shape[0]):
            ...
            ax.set_xticklabels(map(str, np.linspace(0,500,6, dtype=int)))
    ...
    def plot_spectrograms(self, wav_file):
        ...
        ax1.set_xticklabels(map(str, np.linspace(0,0.5*len(index),6, dtype=int)))
        ...
        ax2.set_xticklabels(map(str, np.linspace(0,0.5*len(index),6, dtype=int)))
